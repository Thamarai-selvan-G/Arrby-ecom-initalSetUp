...
export const fashionProducts = [
  {
    ...
    price: 16.95,
    colors: [
      { name: "Orange", colorClass: "bg_orange-3", imgSrc: "/images/products/fashion-3.svg" , price: 7,
        oldPrice: 10, },
      { name: "Black", colorClass: "bg_dark", imgSrc: "/images/fashion-2.svg" , price: 8,
        oldPrice: 10,},
      { name: "White", colorClass: "bg_white", imgSrc: "/images/fashion-1.svg", price: 9,
        oldPrice: 10,},
    ],
    sizes: ["S", "M", "L", "XL"],
    filterCategories: ["Best seller", "On Sale"],
